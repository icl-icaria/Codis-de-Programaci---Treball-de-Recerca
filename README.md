En aquesta pàgina web, es pot accedir als codis complets de programació realitzats per calcular el coeficient de correlació mitjançant la regressió lineal múltiple.
